...
outname="sscs.sc_all_samples_combined"
file="${work_path}/VCFs/*sorted.sscs.sc.filtered.case_only.vcf.gz"

bcftools merge ${work_path}/VCFs/*sorted.sscs.sc.filtered.case_only.vcf.gz -Oz -0 -o ${merged_path}/${outname}.filtered.vcf.gz  && echo "** merge vcfs done **"
